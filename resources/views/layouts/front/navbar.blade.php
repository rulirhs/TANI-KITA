            ...
            <div class="row align-items-center">
                <div class="col-md-2 col-6">
                    <div class="logo text-capitalize m-0 text-dark">
                        <a href="{{ url('') }}" class="text--logo" style="ont-weight: 600;">{{ env('APP_NAME') }}</a>
                    </div>
                </div>

                <div class="col-md-10 col-6 d-inline-flex">
                    @if(auth()->user())
                        <div class="right-bar ml-auto text-dark">
                        <div class="sinlge-bar d-none d-md-block">
                            <marquee>
                            <h6 class="text-dark px-5">Pengiriman COD</h6>
                            </marquee>
                        </div>
                    ...
                    <div class="right-bar ml-auto">
                        ...
                        <div class="sinlge-bar">
                            <a href="{{ route('auth.login') }}" class="btn btn-sm rounded bg-white text-primary shadow btn--shopping-start">Mulai Belanja</a>
                        </div>
                    </div>
                    @endif
                </div>
